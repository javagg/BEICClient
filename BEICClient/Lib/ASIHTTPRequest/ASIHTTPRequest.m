...
- (NSMutableDictionary *)findCredentials
{
	...
	if (user && pass) {
		...
		// If this is a HEAD request generated by an ASINetworkQueue, we'll try to use the details from the main request
		if ([self mainRequest] && [[self mainRequest] usernameTextField] && [[self mainRequest] passwordTextField]) {
			user = [[self mainRequest] usernameTextField];
			pass = [[self mainRequest] passwordTextField];
